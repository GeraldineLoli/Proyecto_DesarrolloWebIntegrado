...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:4200", "http://localhost:60520"));
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT,  "/api/pedidos/{id}").authenticated()
                ...
                .requestMatchers(HttpMethod.GET,  "/api/entradas/evento/**").authenticated()
                ...
                .requestMatchers(HttpMethod.POST, "/api/promociones/{id}/usar").authenticated()
